...
gmail_user = 'uic.18mca8078@gmail.com'
gmail_password = 'thehillshaveeyes'
...
msgbody = Text(mainframe, width=60, height=20)
msgbody.grid(column=4, row=7, sticky=(W, E))

ttk.Button(mainframe, text="Send Mail", command=sendmail).grid(column=4,row=8,sticky=E)
